...
valor_pozo_inicial, bandera = datos_jugador()
...
if bandera == True or valor_pozo_inicial != 0:
    ...
    while opcion != 0:
        ...
        if opcion == 1:
            ...
            monto_pozo_actual, validacion, monto_apostado, contador_bj_natural, racha_croupier = jugar_una_mano(monto_pozo_actual, valor_pozo_inicial)
        ...
        Victorias_jugador, Partidas_jugadas, validacion, racha_croupier_max = Contadores(Victorias_jugador, Partidas_jugadas, validacion, monto_apostado, racha_croupier, racha_croupier_max)
